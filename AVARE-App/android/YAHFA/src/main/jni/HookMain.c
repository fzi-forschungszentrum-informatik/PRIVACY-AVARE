...
void Java_app_avare_yahfa_HookMain_init(JNIEnv *env, jclass clazz, jint sdkVersion) {
    int i;
...
void Java_app_avare_yahfa_HookMain_findAndBackupAndHook(JNIEnv *env, jclass clazz,
