package app.avare.avarebox.effects;
...
public class ExplosionAnimator extends ValueAnimator {
	...
	private static final float X = VUiKit.dpToPx(MainApplication.getApp(), 5);
	private static final float Y = VUiKit.dpToPx(MainApplication.getApp(), 20);
	private static final float V = VUiKit.dpToPx(MainApplication.getApp(), 2);
	private static final float W = VUiKit.dpToPx(MainApplication.getApp(), 1);
