package app.avare.avarebox.home.location;
...
import app.avare.avarebox.home.adapters.AppLocationAdapter;
import app.avare.avarebox.home.models.LocationData;
import app.avare.avarebox.home.repo.AppRepository;

import static app.avare.avarebox.home.location.MarkerActivity.EXTRA_LOCATION;
