    ...
    try {
      const granted = await PermissionsAndroid.request(
        PermissionsAndroid.PERMISSIONS.READ_CONTACTS,
        {
          ...
          'message': 'AVARE zeigt eine Liste deiner Kontakte an, ' +
            'damit du auswählen kannst, welche Kontakte an andere Apps weitergegeben werden. ' +
            'Dazu benötigt AVARE Zugriff auf dein Adressbuch.'
        }
      )
      if (granted === PermissionsAndroid.RESULTS.GRANTED) {
        console.log("AVARE can read Contacts")
