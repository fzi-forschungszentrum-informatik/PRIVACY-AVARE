      ...
      <View style={{ backgroundColor: colors.background }}>
        <PreferencesHeader title="Kalenderfilter" />
            <List.Item 
              ...
              onPress={() => {
              this.props.navigation.navigate('CalendarItemsFilter', { contextID: this.state.contextID, context: this.state.context });
            }} />
            <List.Item 
              title="Felder freigeben"
              onPress={() => {
              this.props.navigation.navigate('CalendarFieldsFilter', { contextID: this.state.contextID, context: this.state.context });
            }}/>
...
export default withTheme(CalendarFilter);