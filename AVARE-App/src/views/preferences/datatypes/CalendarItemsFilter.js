        ...
        try {
            const granted = await PermissionsAndroid.request(
                PermissionsAndroid.PERMISSIONS.READ_CALENDAR,
                {
                    ...
                    'message': 'AVARE zeigt eine Liste deiner Kalender an, ' +
                        'damit du auswählen kannst, welche Kalender an andere Apps weitergegeben werden. ' +
                        'Dazu benötigt AVARE Zugriff auf deine Kalender.'
                }
            )
            if (granted === PermissionsAndroid.RESULTS.GRANTED) {
                console.log("AVARE can read Kalender")
