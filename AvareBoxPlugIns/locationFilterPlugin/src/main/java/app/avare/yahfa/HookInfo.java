 ...
 * Edited by AVARE Project 2018/08/23
 */
...
public class HookInfo {
    ...
    public static String[] hookItemNames = {
            "app.avare.plugin.locationFilterPlugin.Hook_Location_getLatitude",
            "app.avare.plugin.locationFilterPlugin.Hook_Location_getLongitude"
    };
}
