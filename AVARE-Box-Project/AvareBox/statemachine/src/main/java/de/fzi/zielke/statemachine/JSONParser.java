...
public class JSONParser {
    ...
    public JSONParser() {
        ...
        this.writer = new FileWriter("exampleSettings.json");
        this.config = fr.readFile("exampleSettings.json");
        try {
    ...
    private String getPackageName() {
        ...
        try {
            ...
            for (StackTraceElement ste : stes) {
                ...
                if (!packageName.startsWith("app.avare") && !packageName.startsWith("android") && !packageName.startsWith("de.fzi.zielke")) {
