export let settingsSaved = [
  ...
  {
    key: 'history', // smsHistory, mmsHistory and callsHistory in JSON
...
export let settingsLive = [
  ...
  {
    key: 'cammic', // camera and mic in JSON
  ...
  {
    key: 'transfer', // internet, bluetooth and nfc in JSON
  ...
  {
    key: 'communication', // calls, sms in JSON
    name: 'Kommunikation',
  ...
  {
    key: 'sensors', // environment, movement and body in JSON
    name: 'Sensoren',
